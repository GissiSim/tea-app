...
;(function() {
  var Favico = function(opt) {
    ...
    type.circle = function(opt) {
      ...
      _context.beginPath()
      _context.font =
        _opt.fontStyle + ' ' + Math.floor(opt.h * (opt.n > 99 ? 0.85 : 1)) + 'px ' + _opt.fontFamily
      ...
      _context.fillStyle =
        'rgba(' + _opt.bgColor.r + ',' + _opt.bgColor.g + ',' + _opt.bgColor.b + ',' + opt.o + ')'
      _context.fill()
      _context.closePath()
      _context.beginPath()
      _context.stroke()
    ...
    type.rectangle = function(opt) {
      ...
      _context.beginPath()
      _context.font =
        _opt.fontStyle + ' ' + Math.floor(opt.h * (opt.n > 99 ? 0.9 : 1)) + 'px ' + _opt.fontFamily
      _context.textAlign = 'center'
      _context.fillStyle =
        'rgba(' + _opt.bgColor.r + ',' + _opt.bgColor.g + ',' + _opt.bgColor.b + ',' + opt.o + ')'
